...
#     def __init__(self, port, baud, bootloader_address, partition_table_address, ota_data_address, firmware_address):
#         super().__init__()
#         self.utils = Utils()
#         self.port = port
#         self.baud = baud
...
#     def run(self):
#         """Runs the firmware flashing process."""
...
#             if success_detected:
#                 self.show_message.emit("Success", "Firmware flashing completed successfully!")
